...
public class UserLikedController implements Initializable {
    ...
    private StackList<Liked> likeds;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        int row = 1;
        try {
            likeds = db.sqlSelectLikes(LoginController.activeUser.getId());
            Node<Liked> temp = likeds.head;
            while(temp!=null){
